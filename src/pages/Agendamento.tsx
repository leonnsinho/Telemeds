        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-3xl shadow-2xl overflow-hidden border border-green-100">
            ...
            <div className="p-8">
              ...
              <div className="text-center">
                <a
                  href="https://wa.me/5511921110959?text=Olá! Gostaria de agendar uma consulta. Podem me ajudar?"
                  target="_blank"
                ...
                <p className="text-gray-600 text-sm mt-4">
                  Ou ligue: <a href="tel:+5511921110959" className="text-green-600 font-medium hover:text-green-700">+55 11 92111-0959</a>
                </p>
