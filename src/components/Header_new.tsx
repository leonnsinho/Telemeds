        ...
        <div className={`transition-all duration-700 ease-out rounded-2xl backdrop-blur-md border shadow-lg ${
          ...
          <div className="flex justify-between items-center h-full">
            ...
            <nav className={`hidden md:flex items-center transition-all duration-700 ease-out ${
              ...
              <button className={`btn-primary text-white rounded-full font-medium flex items-center transition-all duration-500 ease-out ${
                isScrolled ? 'px-3 py-2 text-sm space-x-1' : 'px-6 py-3 space-x-2'
              }`}>
                <Calendar className={`transition-all duration-500 ease-out ${isScrolled ? 'w-4 h-4' : 'w-5 h-5'}`} />
                <span className={`transition-all duration-700 ease-out overflow-hidden ${
                  isScrolled 
